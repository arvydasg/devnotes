...
jeigu kartais noresi pasileisti emacs in tmux (shudas, kol kas neradau
kaip padaryti, kad galeciau close all header sin .org file), tai
noresi tikriausiai ir spalvas atitaikyti. By default jeigu per tmux
paleidi emacs -nw, tuomet buna shudinos spalvos.
